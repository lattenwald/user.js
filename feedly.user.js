...
(function() {
  ...
  style.type = 'text/css';
  style.innerHTML =
    '.condensed .entryholder .u100Entry {margin-left: 20px !important; margin-right: 0 !important; max-width: none !important;}' +
    ...
    'div .button.primary.small {background-color: #aaa !important;}' +
...
document.addEventListener("DOMNodeInserted", function (ev) {
	el = document.querySelector('img[src^="http://www.shorpy.com/files/images/"]');
    if(!el) {return}
